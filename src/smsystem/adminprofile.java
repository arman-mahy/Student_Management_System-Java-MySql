...
public class adminprofile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 20, 260, 100));

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Enter New Password");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 240, 190, 40));
        getContentPane().add(passw, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 280, 230, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 330, -1, -1));
        getContentPane().add(un, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 210, 200, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql = "Update sms.user_login set password='" + passw.getText()+ "'" + "where username=" + un.getText();  
